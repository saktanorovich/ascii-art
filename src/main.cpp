...
int main(int argc, char* argv[]) {
    ...
    description.add_options()
        ...
        ("height" , po::value<int>()->default_value(130) , "Output image height")
        ("width"  , po::value<int>()->default_value(80) , "Output image width");
    ...
    auto file_name = variables_map["image"].as<std::string>();
    auto h = variables_map["height"].as<int>();
    auto w = variables_map["width"].as<int>();
    ascii::renderer renderer;
    renderer.make_art_from_jpeg(file_name, h, w);
}
